...
class OverlayView(context: Context?, attrs: AttributeSet?) :
    ...
    private var tts: TextToSpeech? = null    ////////////added//////////////
    private var text: String? = null         ////////////added//////////////
    ...
    override fun draw(canvas: Canvas) {
        ...
        results?.detections()?.map {
            ...
            Log.d("ObjectDetection", "Detected object at index $index: $floats")  ///////added//////
            ...
            tts = TextToSpeech(context) { status ->
                if (status == TextToSpeech.SUCCESS) {
                    ...
                    if (result == TextToSpeech.LANG_MISSING_DATA || result == TextToSpeech.LANG_NOT_SUPPORTED) {
                        ...
                        Log.d("TTS", "The Language supported!")
                        if (index==0 || (index > 0 && text != (results?.detections()!![index-1].categories()[0]).categoryName())){
                            Log.d("TextToSpeech", "Speaking: $text")
                            // spell out the object name
